...
C {port_diff.sym} 330 -280 0 0 {name=P1 portnum=1 Z0=85 DCval=0 ACmag=1 ACphase=0 TRANval="SIN(0 \{VIN_PP\} 77Geg 0 0 0)"
}
...
.PRINT TRAN FORMAT=RAW FILE=RXAMP_77GD_TBTRAN.raw V(*) I(*) ICC ICC_RMS OUTD
.FOUR 77G V(OUTP,OUTN)
"
}
C {code.sym} 150 -1020 0 0 {name=AC only_toplevel=false value="
.PREPROCESS REPLACEGROUND TRUE
.AC LIN 201 50G 110G
.LIN FORMAT=TOUCHSTONE FILE=RXAMP_77GD_TBAC.s2p LINTYPE=S DATAFORMAT=MA
"
spice_ignore=true}
C {code.sym} 270 -1020 0 0 {name=NOISE only_toplevel=false value="
.PREPROCESS REPLACEGROUND TRUE
.NOISE V(OUTP,OUTN) P1 LIN 201 50G 110G
...
simulate
"}
C {title.sym} 160 -30 0 0 {name=l8 author="77GHz LNA Testbench - Phased Array Vibrometer" lock=true}
C {launcher.sym} 1040 -910 0 0 {name=h5
descr="load waves TRAN"
tclcommand="xschem raw_read $netlist_dir/RXAMP_77GD_TBTRAN.raw tran"
}
...
C {RXAMP_77GD.sym} 520 -280 0 0 {name=x1}

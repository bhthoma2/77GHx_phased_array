...
N 100 -550 450 -550 {lab=VCC}
N 220 -550 220 -450 {lab=VCC}
N 380 -550 380 -450 {lab=VCC}
N 220 -450 220 -380 {lab=OUTP}
N 380 -450 380 -380 {lab=OUTP}
N 220 -380 220 -330 {lab=OUTP}
N 380 -380 380 -330 {lab=OUTN}
N 140 -380 220 -380 {lab=OUTP}
N 380 -380 460 -380 {lab=OUTN}
N 260 -450 260 -420 {lab=OUTP}
N 340 -450 340 -420 {lab=OUTN}
N 220 -450 260 -450 {lab=OUTP}
N 340 -450 380 -450 {lab=OUTN}
...
El=2.5
selft=0}
C {sg13g2_pr/sg13_svaricap.sym} 260 -420 0 0 {name=CV1
model=SVaricap
spiceprefix=X
w=0.6u
l=0.6u
m=1}
C {sg13g2_pr/sg13_svaricap.sym} 340 -420 0 1 {name=CV2
model=SVaricap
spiceprefix=X
w=0.6u
l=0.6u

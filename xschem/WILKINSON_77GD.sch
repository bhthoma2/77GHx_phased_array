...
C {YTRANSLINE.sym} 535 -475 0 0 {name=TL17 R=13.55k L=331.35n C=91.75p len=590u lumps=50 Z0=60}
C {YTRANSLINE.sym} 535 -375 0 0 {name=TL18 R=13.55k L=331.35n C=91.75p len=590u lumps=50 Z0=60}
C {YTRANSLINE.sym} 535 -315 0 0 {name=TL19 R=13.55k L=331.35n C=91.75p len=590u lumps=50 Z0=60}
C {YTRANSLINE.sym} 535 -215 0 0 {name=TL20 R=13.55k L=331.35n C=91.75p len=590u lumps=50 Z0=60}
...
C {title.sym} 160 -35 0 0 {name=l1 author="Modified for 77GHz Phased Array - lambda/4 at 77GHz" lock=true}
...
C {simulator_commands_shown.sym} 20 -650 0 0 {name=Libs_Xyce
simulator=xyce
only_toplevel=false
value="tcleval(
.lib $::SG13G2_MODELS_XYCE/cornerRES.lib res_typ
)"}
C {simulator_commands_shown.sym} 0 -570 0 0 {name=Libs_ngspice
simulator=ngspice
only_toplevel=false
value="tcleval(
